...
class ExamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post examples_url, params: { example: { answers: @example.answers, class_name: @example.class_name, definition_id: @example.definition_id, name: @example.name } }
    end
  ...
  test "should update example" do
    patch example_url(@example), params: { example: { answers: @example.answers, class_name: @example.class_name, definition_id: @example.definition_id, name: @example.name } }
